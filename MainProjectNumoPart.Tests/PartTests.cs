    ...
    public class PartTests
    {
        ...
        public void NumericValuesNeverChange()
        {
            var expected = new Dictionary<Part, int>
            {
                ...
                [Part.CowlPanel] = 50,
                [Part.PillarALeft] = 51,
                [Part.PillarARight] = 52,
                [Part.PillarBLeft] = 53,
                [Part.PillarBRight] = 54,
                [Part.PillarCLeft] = 55,
                [Part.PillarCRight] = 56,
                [Part.DripRailLeft] = 57,
                [Part.DripRailRight] = 58,
                [Part.DoorGlassFrontLeft] = 59,
                [Part.DoorGlassFrontRight] = 60,
                [Part.DoorGlassRearLeft] = 61,
                [Part.DoorGlassRearRight] = 62,
                [Part.QuarterGlassLeft] = 63,
                [Part.QuarterGlassRight] = 64,
                [Part.CentreGarnish] = 65,
                [Part.RearValance] = 66,
                [Part.DoorHandleFrontLeft] = 67,
                [Part.DoorHandleFrontRight] = 68,
                [Part.DoorHandleRearLeft] = 69,
                [Part.DoorHandleRearRight] = 70,
                [Part.SideRepeaterLeft] = 71,
                [Part.SideRepeaterRight] = 72,
                [Part.Wipers] = 73,
                [Part.FrontPlate] = 74,
                [Part.RearPlate] = 75,
                [Part.ExhaustTips] = 76,
